  ...
  return (
    <Layout className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Contact Information */}
        <div className="text-center mb-8">
          <div className="bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 max-w-2xl mx-auto">
            ...
            <a 
              ...
              className="text-orange-600 dark:text-orange-500 hover:text-orange-700 dark:hover:text-orange-400 font-medium transition-colors"
            >
              write@digiwares.xyz
            </a>
          </div>
        ...
        <div className="space-y-8">
          {/* FAQ Section */}
          <section>
            <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-6">Frequently Asked Questions</h2>
            <div className="space-y-4">
              <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">How does voice recognition work?</h3>
              ...
              <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">Is my data secure?</h3>
                <p className="text-gray-600 dark:text-slate-400">
                  Yes! Your voice recordings and organized content are stored locally in your browser. We don't collect, store, or transmit any personal data. See our <Link href="/privacy" className="text-orange-600 dark:text-orange-500 hover:text-orange-700 dark:hover:text-orange-400">Privacy Policy</Link> for details.
                </p>
              </div>

              <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">Which browsers are supported?</h3>
                <p className="text-gray-600 dark:text-slate-400">
              ...
              <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">Can I use tickk offline?</h3>
                <p className="text-gray-600 dark:text-slate-400">
              ...
              <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">How accurate is the speech recognition?</h3>
                <p className="text-gray-600 dark:text-slate-400">
          ...
          {/* Response Times */}
          <section>
            <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Response Times</h2>
          ...
          <section>
            <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Before You Contact Us</h2>
            <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4">
              <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-3">Help Us Help You</h3>
        ...
        <div className="text-center bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 mt-8">
          <h3 className="heading-secondary text-gray-900 dark:text-slate-100 mb-4">Ready to Get in Touch?</h3>
