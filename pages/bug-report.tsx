  ...
  return (
    <Layout className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Bug Categories */}
        <div className="mb-8">
          <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Common Bug Categories</h2>
          <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4">
            <p className="text-gray-600 dark:text-slate-400 mb-3">We track issues in these main areas:</p>
        ...
        <div className="space-y-8">
          {/* Quick Checks */}
          <section>
            <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Before Reporting</h2>
            <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4">
              <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-3">Quick Troubleshooting</h3>
              <p className="text-gray-600 dark:text-slate-400 mb-3">
                Please try these steps first - they resolve most common issues:
              </p>
              <ul className="text-gray-600 dark:text-slate-400 space-y-2 ml-4">
          ...
          {/* Bug Report Template */}
          <section>
            <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Bug Report Information</h2>
            <div className="border-l-4 border-gray-200 dark:border-slate-700 pl-4">
              <h3 className="font-semibold text-gray-900 dark:text-slate-100 mb-3">What to Include</h3>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">1. Bug Description</h4>
                  <ul className="text-gray-600 dark:text-slate-400 space-y-1 ml-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">2. Steps to Reproduce</h4>
                  <ul className="text-gray-600 dark:text-slate-400 space-y-1 ml-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">3. Technical Information</h4>
                  <ul className="text-gray-600 dark:text-slate-400 space-y-1 ml-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-slate-100 mb-2">4. Additional Details</h4>
                  <ul className="text-gray-600 dark:text-slate-400 space-y-1 ml-4">
        ...
        <div className="text-center bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 mt-8">
          <h3 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Ready to Report?</h3>
