    ...
    <>
      ...
      <Layout showHomeLink={true}>
        <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 hover:border-orange-200 hover:shadow-sm transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Voice-to-Text Transcription</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 hover:border-orange-200 hover:shadow-sm transition-all duration-300">
                <div className="text-4xl mb-4">🧠</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Smart NLP Classification</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 hover:border-orange-200 hover:shadow-sm transition-all duration-300">
                <div className="text-4xl mb-4">📊</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Productivity Analytics</h3>
                <p className="text-gray-600 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto mb-20 bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-12">
            <h2 className="heading-secondary text-gray-900 text-center mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Zero Data Collection</h3>
              ...
              <div className="text-center">
                <div className="text-5xl mb-4">🏠</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Local Processing</h3>
                <p className="text-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-50 rounded-xl p-8">
                <div className="flex items-start gap-4">
                  <div className="text-3xl">📅</div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Calendar Export (.ics)</h3>
                    <p className="text-gray-600">
              ...
              <div className="bg-gray-50 rounded-xl p-8">
                <div className="flex items-start gap-4">
                  <div className="text-3xl">📋</div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Context Menu Actions</h3>
                    <p className="text-gray-600">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-12">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Screen Reader Support</h4>
                    <p className="text-gray-600">Full ARIA labels and live regions for visually impaired users.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Complete keyboard-only control without touching the mouse.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-2xl">🎨</div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">High Contrast Mode</h4>
                    <p className="text-gray-600">Enhanced visibility for users with visual impairments.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-2xl">🎭</div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Reduced Motion</h4>
                    <p className="text-gray-600">Respects prefers-reduced-motion for sensitive users.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="bg-gray-900 text-white rounded-lg p-12">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  <h3 className="text-xl font-bold mb-4 text-orange-400">Technology Stack</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 text-orange-400">Browser Support</h3>
                  <ul className="space-y-2 text-gray-300">
                    <li>• Chrome 25+</li>
                    <li>• Edge 79+</li>
                    <li>• Safari 14.1+</li>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 text-orange-400">Platform</h3>
                  <ul className="space-y-2 text-gray-300">
                    <li>• Web-based</li>
              ...
              <table className="w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-center text-sm font-bold text-orange-600">tickk</th>
                    <th className="px-6 py-4 text-center text-sm font-bold text-gray-600">Other Apps</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    <td className="px-6 py-4 text-gray-900">Voice Recognition</td>
                    <td className="px-6 py-4 text-center text-green-600 font-bold">✓ Free</td>
                    <td className="px-6 py-4 text-center text-gray-400">Paid Feature</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 text-gray-900">No Signup Required</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 text-gray-900">Privacy (Local Storage)</td>
                    <td className="px-6 py-4 text-center text-green-600 font-bold">✓</td>
                    <td className="px-6 py-4 text-center text-red-600 font-bold">✗ Cloud</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 text-gray-900">Offline Support</td>
                    <td className="px-6 py-4 text-center text-green-600 font-bold">✓</td>
                    <td className="px-6 py-4 text-center text-red-600 font-bold">✗</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 text-gray-900">ADHD-Friendly Focus Mode</td>
                    <td className="px-6 py-4 text-center text-green-600 font-bold">✓</td>
                    <td className="px-6 py-4 text-center text-gray-400">Limited</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 text-gray-900">Open Source</td>
                    <td className="px-6 py-4 text-center text-green-600 font-bold">✓</td>
                    <td className="px-6 py-4 text-center text-red-600 font-bold">✗</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-6 py-4 text-center text-gray-600">$5-15/month</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Final CTA */}
          <div className="max-w-4xl mx-auto text-center bg-gray-900 rounded-lg p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/landing"
                className="inline-flex items-center justify-center px-8 py-4 bg-transparent hover:bg-gray-800 text-white font-semibold rounded-lg border-2 border-white transition-colors duration-200"
              >
