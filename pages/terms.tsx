        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2">Your Data</h3>
              <p className="text-gray-600 dark:text-slate-400 text-sm">You own and control all your content</p>
            </div>
            
            <div className="bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 text-center">
              <div className="text-2xl mb-2">📱</div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2">Browser-Based</h3>
              <p className="text-gray-600 dark:text-slate-400 text-sm">Works entirely in your web browser</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Use of the Service</h2>
              <div className="prose max-w-none">
                ...
                <ul className="text-gray-600 dark:text-slate-400 space-y-2 mb-4">
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Your Content</h2>
              <p className="text-gray-600 dark:text-slate-400 mb-4">
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Service Availability</h2>
              <p className="text-gray-600 dark:text-slate-400 mb-4">
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Prohibited Uses</h2>
              <div className="prose max-w-none">
                <p className="text-gray-600 dark:text-slate-400 mb-4">You may not use tickk for:</p>
                <ul className="text-gray-600 dark:text-slate-400 space-y-2 mb-4">
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Limitation of Liability</h2>
              <p className="text-gray-600 dark:text-slate-400 mb-4">
            ...
            <section>
              <h2 className="heading-secondary text-gray-900 dark:text-slate-50 mb-4">Changes to Terms</h2>
              <p className="text-gray-600 dark:text-slate-400 mb-4">
          ...
          <div className="text-center bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 mt-8">
            <h3 className="heading-secondary text-gray-900 dark:text-slate-100 mb-4">Questions About These Terms?</h3>
            <p className="text-gray-600 dark:text-slate-400 mb-4">
