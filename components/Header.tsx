            ...
            {isAppPage ? (
              ...
              <nav className="flex items-center gap-6">
                ...
                <Link href="/transform" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
                  ...
                  <span>Transform</span>
                  <span className="text-xs bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-300 px-1.5 py-0.5 rounded-full font-semibold">
                    NEW
                  </span>
                </Link>
        ...
        <>
          ...
          <div className="md:hidden absolute top-full left-0 right-0 z-[55] border-b border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg">
            <div className="mx-auto max-w-6xl px-4 py-3 space-y-2">
              ...
              <Link 
                href="/transform" 
                className="flex items-center justify-between px-3 py-2 text-base font-medium text-gray-700 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-gray-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
                onClick={() => setMobileMenuOpen(false)}
              >
                ...
                <span className="text-xs bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-300 px-2 py-1 rounded-full font-semibold">
                  NEW
                </span>
              </Link>
              <Link 
