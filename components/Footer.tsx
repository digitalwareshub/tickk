        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/app" className="text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
                  Voice Dashboard
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/#how-it-works" className="text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
